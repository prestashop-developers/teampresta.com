            ...
            <div class="container">
                <div class="additional-info-items">
                    ...
                    <div class="reason-text">
                        <a href="mailto:webmaster@teampresta.com" id="dynamicProviderLink" title="webmaster@teampresta.com" rel="noopener noreferrer">Contact your hosting provider</a> for more information.
                    </div>
                </div>
            </div>
        </section>
